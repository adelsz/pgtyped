...
export class SQLParser extends Parser {
	...
	public static readonly RULE_hintedColumnAliasName = 7;
	...
	public static readonly ruleNames: string[] = [
		...
		"word", "hintedColumnAliasName", "param", "paramId", "nameTag", "paramTag", 
		"paramTransform", "transformRule", "spreadTransform", "pickTransform", 
		"spreadPickTransform", "key", "queryName", "paramName",
	];
	...
	public statementBody(): StatementBodyContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SQLParser.ID) | (1 << SQLParser.AS) | (1 << SQLParser.OPEN_COMMENT) | (1 << SQLParser.S_REQUIRED_MARK) | (1 << SQLParser.S_OPTIONAL_MARK) | (1 << SQLParser.WORD) | (1 << SQLParser.DOUBLE_QUOTE) | (1 << SQLParser.STRING) | (1 << SQLParser.PARAM_MARK))) !== 0)) {
				{
				this.state = 83;
				this._errHandler.sync(this);
	...
	public word(): WordContext {
		...
		try {
			...
			this.state = 88;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SQLParser.ID) | (1 << SQLParser.AS) | (1 << SQLParser.S_REQUIRED_MARK) | (1 << SQLParser.S_OPTIONAL_MARK) | (1 << SQLParser.WORD) | (1 << SQLParser.DOUBLE_QUOTE) | (1 << SQLParser.STRING))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public hintedColumnAliasName(): HintedColumnAliasNameContext {
		...
		this.enterRule(_localctx, 14, SQLParser.RULE_hintedColumnAliasName);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this.state = 93;
			_la = this._input.LA(1);
			if (!(_la === SQLParser.S_REQUIRED_MARK || _la === SQLParser.S_OPTIONAL_MARK)) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x19\x98\x04\x02" +
		...
		"\x0F\x03\x0F\x03\x0F\x05\x0Fw\n\x0F\x03\x10\x03\x10\x03\x10\x03\x10\x03" +
		"\x11\x03\x11\x03\x11\x03\x11\x07\x11\x81\n\x11\f\x11\x0E\x11\x84\v\x11" +
		"\x03\x11\x05\x11\x87\n\x11\x03\x11\x03\x11\x03\x12\x03\x12\x03\x12\x03" +
		"\x12\x03\x12\x03\x13\x03\x13\x05\x13\x92\n\x13\x03\x14\x03\x14\x03\x15" +
		"\x03\x15\x03\x15\x03H\x02\x02\x16\x02\x02\x04\x02\x06\x02\b\x02\n\x02" +
		"\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A\x02\x1C\x02" +
		"\x1E\x02 \x02\"\x02$\x02&\x02(\x02\x02\x05\x03\x02\x11\x11\x05\x02\x03" +
		"\x04\x06\t\f\f\x03\x02\x06\x07\x02\x91\x021\x03\x02\x02\x02\x047\x03\x02" +
		"\x02\x02\x06:\x03\x02\x02\x02\bD\x03\x02\x02\x02\nM\x03\x02\x02\x02\f" +
		"P\x03\x02\x02\x02\x0EZ\x03\x02\x02\x02\x10\\\x03\x02\x02\x02\x12b\x03" +
		"\x02\x02\x02\x14e\x03\x02\x02\x02\x16i\x03\x02\x02\x02\x18l\x03\x02\x02" +
		"\x02\x1Ap\x03\x02\x02\x02\x1Cv\x03\x02\x02\x02\x1Ex\x03\x02\x02\x02 |" +
		"\x03\x02\x02\x02\"\x8A\x03\x02\x02\x02$\x8F\x03\x02\x02\x02&\x93\x03\x02" +
		"\x02\x02(\x95\x03\x02\x02\x02*,\x05\b\x05\x02+*\x03\x02\x02\x02,/\x03" +
		"\x02\x02\x02-+\x03\x02\x02\x02-.\x03\x02\x02\x02.0\x03\x02\x02\x02/-\x03" +
		"\x02\x02\x0202\x05\x04\x03\x021-\x03\x02\x02\x0223\x03\x02\x02\x0231\x03" +
		"\x02\x02\x0234\x03\x02\x02\x0245\x03\x02\x02\x0256\x07\x02\x02\x036\x03" +
		"\x03\x02\x02\x0278\x05\x06\x04\x0289\x05\n\x06\x029\x05\x03\x02\x02\x02" +
		":;\x07\x05\x02\x02;?\x05\x16\f\x02<>\x05\x18\r\x02=<\x03\x02\x02\x02>" +
		"A\x03\x02\x02\x02?=\x03\x02\x02\x02?@\x03\x02\x02\x02@B\x03\x02\x02\x02" +
		"A?\x03\x02\x02\x02BC\x07\x18\x02\x02C\x07\x03\x02\x02\x02DH\x07\x05\x02" +
		"\x02EG\n\x02\x02\x02FE\x03\x02\x02\x02GJ\x03\x02\x02\x02HI\x03\x02\x02" +
		"\x02HF\x03\x02\x02\x02IK\x03\x02\x02\x02JH\x03\x02\x02\x02KL\x07\x18\x02" +
		"\x02L\t\x03\x02\x02\x02MN\x05\f\x07\x02NO\x07\n\x02\x02O\v\x03\x02\x02" +
		"\x02PW\x05\x0E\b\x02QV\x05\b\x05\x02RV\x05\x10\t\x02SV\x05\x12\n\x02T" +
		"V\x05\x0E\b\x02UQ\x03\x02\x02\x02UR\x03\x02\x02\x02US\x03\x02\x02\x02" +
		"UT\x03\x02\x02\x02VY\x03\x02\x02\x02WU\x03\x02\x02\x02WX\x03\x02\x02\x02" +
		"X\r\x03\x02\x02\x02YW\x03\x02\x02\x02Z[\t\x03\x02\x02[\x0F\x03\x02\x02" +
		"\x02\\]\x07\x04\x02\x02]^\x07\t\x02\x02^_\x07\x03\x02\x02_`\t\x04\x02" +
		"\x02`a\x07\t\x02\x02a\x11\x03\x02\x02\x02bc\x07\r\x02\x02cd\x05\x14\v" +
		"\x02d\x13\x03\x02\x02\x02eg\x07\x03\x02\x02fh\x07\x06\x02\x02gf\x03\x02" +
		"\x02\x02gh\x03\x02\x02\x02h\x15\x03\x02\x02\x02ij\x07\x11\x02\x02jk\x05" +
		"&\x14\x02k\x17\x03\x02\x02\x02lm\x07\x12\x02\x02mn\x05(\x15\x02no\x05" +
		"\x1A\x0E\x02o\x19\x03\x02\x02\x02pq\x07\x0F\x02\x02qr\x05\x1C\x0F\x02" +
		"r\x1B\x03\x02\x02\x02sw\x05\x1E\x10\x02tw\x05 \x11\x02uw\x05\"\x12\x02" +
		"vs\x03\x02\x02\x02vt\x03\x02\x02\x02vu\x03\x02\x02\x02w\x1D\x03\x02\x02" +
		"\x02xy\x07\x13\x02\x02yz\x07\x10\x02\x02z{\x07\x14\x02\x02{\x1F\x03\x02" +
		"\x02\x02|}\x07\x13\x02\x02}\x82\x05$\x13\x02~\x7F\x07\x15\x02\x02\x7F" +
		"\x81\x05$\x13\x02\x80~\x03\x02\x02\x02\x81\x84\x03\x02\x02\x02\x82\x80" +
		"\x03\x02\x02\x02\x82\x83\x03\x02\x02\x02\x83\x86\x03\x02\x02\x02\x84\x82" +
		"\x03\x02\x02\x02\x85\x87\x07\x15\x02\x02\x86\x85\x03\x02\x02\x02\x86\x87" +
		"\x03\x02\x02\x02\x87\x88\x03\x02\x02\x02\x88\x89\x07\x14\x02\x02\x89!" +
		"\x03\x02\x02\x02\x8A\x8B\x07\x13\x02\x02\x8B\x8C\x05 \x11\x02\x8C\x8D" +
		"\x07\x10\x02\x02\x8D\x8E\x07\x14\x02\x02\x8E#\x03\x02\x02\x02\x8F\x91" +
		"\x07\x03\x02\x02\x90\x92\x07\x16\x02\x02\x91\x90\x03\x02\x02\x02\x91\x92" +
		"\x03\x02\x02\x02\x92%\x03\x02\x02\x02\x93\x94\x07\x03\x02\x02\x94\'\x03" +
		"\x02\x02\x02\x95\x96\x07\x03\x02\x02\x96)\x03\x02\x02\x02\r-3?HUWgv\x82" +
		"\x86\x91";
...
export class WordContext extends ParserRuleContext {
	...
	public S_OPTIONAL_MARK(): TerminalNode | undefined { return this.tryGetToken(SQLParser.S_OPTIONAL_MARK, 0); }
	public DOUBLE_QUOTE(): TerminalNode | undefined { return this.tryGetToken(SQLParser.DOUBLE_QUOTE, 0); }
...
export class HintedColumnAliasNameContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SQLParser.RULE_hintedColumnAliasName; }
	// @Override
	public enterRule(listener: SQLParserListener): void {
