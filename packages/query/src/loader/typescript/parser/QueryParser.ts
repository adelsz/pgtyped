...
export class QueryParser extends Parser {
  ...
  public query(): QueryContext {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          ((1 << _la) &
            ((1 << QueryParser.ID) |
              ...
              (1 << QueryParser.CB) |
              (1 << QueryParser.WORD) |
              (1 << QueryParser.SPECIAL) |
              (1 << QueryParser.STRING))) !==
            0
        );
        this.state = 40;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (
          _la === QueryParser.SINGULAR_PARAM_MARK ||
          _la === QueryParser.PLURAL_PARAM_MARK
        ) {
          {
            {
              this.state = 31;
  ...
  public scalarParam(): ScalarParamContext {
    let _localctx: ScalarParamContext = new ScalarParamContext(
      this._ctx,
      this.state,
    );
  ...
  public pickParam(): PickParamContext {
    let _localctx: PickParamContext = new PickParamContext(
      this._ctx,
      this.state,
    );
  ...
  public arrayPickParam(): ArrayPickParamContext {
    let _localctx: ArrayPickParamContext = new ArrayPickParamContext(
      this._ctx,
      this.state,
    );
  ...
  public arrayParam(): ArrayParamContext {
    let _localctx: ArrayParamContext = new ArrayParamContext(
      this._ctx,
      this.state,
    );
...
export class InputContext extends ParserRuleContext {
  ...
  public EOF_STATEMENT(): TerminalNode | undefined {
    return this.tryGetToken(QueryParser.EOF_STATEMENT, 0);
  }
...
export class ScalarParamContext extends ParserRuleContext {
  public SINGULAR_PARAM_MARK(): TerminalNode {
    return this.getToken(QueryParser.SINGULAR_PARAM_MARK, 0);
  }
  public paramName(): ParamNameContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_scalarParam;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
...
export class PickParamContext extends ParserRuleContext {
  ...
  public OB(): TerminalNode {
    return this.getToken(QueryParser.OB, 0);
  }
  public pickKey(): PickKeyContext[];
  ...
  public CB(): TerminalNode {
    return this.getToken(QueryParser.CB, 0);
  }
  public COMMA(): TerminalNode[];
  public COMMA(i: number): TerminalNode;
  public COMMA(i?: number): TerminalNode | TerminalNode[] {
  ...
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_pickParam;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
...
export class ArrayPickParamContext extends ParserRuleContext {
  public PLURAL_PARAM_MARK(): TerminalNode {
    return this.getToken(QueryParser.PLURAL_PARAM_MARK, 0);
  }
  public paramName(): ParamNameContext {
    return this.getRuleContext(0, ParamNameContext);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_arrayPickParam;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
...
export class ArrayParamContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_arrayParam;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
...
export class ParamNameContext extends ParserRuleContext {
  public ID(): TerminalNode {
    return this.getToken(QueryParser.ID, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_paramName;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
...
export class PickKeyContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return QueryParser.RULE_pickKey;
  }
  // @Override
  public enterRule(listener: QueryParserListener): void {
