...
export function createClientSASLContinueResponse(password, clientNonce, SASLData) {
    const SASLContinueServerVariables = extractVariablesFromSASLContinueServerMessage(SASLData);
...
export function checkServerFinalMessage(serverData, calculatedServerSignature) {
...
function extractVariablesFromSASLContinueServerMessage(data) {
    let nonce;
    let salt;
    let iteration;
    String(data)
...
//# sourceMappingURL=sasl-helpers.js.map