...
const getAllCommentsIR: any = {
  ...
  params: [
    {
      ...
      codeRefs: {
        used: [
          { a: 101, b: 102, line: 3, col: 40 },
          { a: 118, b: 119, line: 3, col: 57 },
        ],
      },
    },
  ],
  ...
  statement: {
    body: 'SELECT * FROM book_comments WHERE id = :id or user_id = :id',
    loc: { a: 61, b: 119, line: 3, col: 0 },
  },
};
  ...
  params: [
    {
      name: 'comments',
      codeRefs: {
        defined: { a: 157, b: 164, line: 7, col: 9 },
        used: [{ a: 249, b: 256, line: 10, col: 8 }],
      },
