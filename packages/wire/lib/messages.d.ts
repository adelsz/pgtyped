...
export declare enum PreparedObjectType {
    Portal = "P",
    Statement = "S"
}
export declare const messages: {
    ...
    authenticationOk: IServerMessage<{}>;
    ...
    authenticationCleartextPassword: IServerMessage<{}>;
    ...
    parameterStatus: IServerMessage<{
    ...
    SASLInitialResponse: IClientMessage<{
     ...
     */
    authenticationSASLFinal: IServerMessage<{
     ...
     */
    parameterDescription: IServerMessage<{
    ...
    closeComplete: IServerMessage<{}>;
    commandComplete: IServerMessage<{
        commandTag: string;
    }>;
};
export {};
